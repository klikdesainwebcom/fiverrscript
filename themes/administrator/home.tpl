			...
			<div class="dashboard-container">
        		...
        		<tr>
            		<td>                                                
                        ...
                        <div class="entry-edit">
                    		<div class="entry-edit-head"><h4>Request Statistics</h4></div>
                    		<fieldset class="np">
                                <div class="grid np">
                                    <table cellspacing="0" style="border:0;" id="lastOrdersGrid_table">
                                        <col   />
                                        ...
                                        <tbody>
                                            <tr>
                                            	<td class=" ">Requests Awaiting Validation</td>
                                                <td class=" a-center last">{insert name=get_total_v2}</td>
                                        	</tr>
                                            <tr>
                                            	<td class=" ">Total Requests</td>
                                                <td class=" a-center last">{insert name=get_total_com value=var table=scriptolutionrequests}</td>
                                        	</tr>
                                        </tbody>
                                    </table>
                                </div>
