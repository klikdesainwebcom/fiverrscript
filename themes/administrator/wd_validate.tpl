	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" last">
                                            ...
                                            {if $results[i].ap eq "1"}<a href="http://www.payza.com" target="_blank">Pay Via Payza</a>{else}<a href="http://www.paypal.com" target="_blank">Pay Via Paypal</a>{/if}&nbsp;&nbsp;&nbsp; <b>>>> Then >>></b>&nbsp;&nbsp;&nbsp;<a href="javascript: document.a{$results[i].WID}.submit();">Mark As Paid (Sets the user's funds to $0)</a></td>
                                	</tr>
                                    {/section}
                                    <tr>
                                    	<td colspan="6">
