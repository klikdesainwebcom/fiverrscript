                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" " style="background-color:#FFC">
                                            ...
                                            {if $results[i].fiverrscriptdotcom_available eq "1"}
                                            	Available Balance
                                            {elseif $results[i].fiverrscriptdotcom_balance eq "1"}
                                            	My Balance
                                            {elseif $results[i].fiverrscriptdotcom_stripe eq "1"}
                                            	Stripe
                                            {else}
                                        ...
                                        <td>
                                        	{if $results[i].scriptolution_totalwfees3 ne "0.00"}
                                            With Processing Fee: ${$results[i].scriptolution_totalwfees3}<br>
                                            Without Processing Fee: ${$results[i].price}
                                            {else}
                                            {if $results[i].t eq "0"}-{/if}${$results[i].price}
                                            {/if}                                        
                                        </td> 
